...
Google OAuth2 using the new [**Google Identity Services SDK**](https://developers.google.com/identity/gsi/web) for React [@moeindana/google-oauth](https://www.npmjs.com/package/@moeindana/google-oauth)🚀

## Install

```sh
$ npm install @moeindana/google-oauth@latest

# or

$ yarn add @moeindana/google-oauth@latest
```
